...
try:
    ...
    params = {
        "force": False,     # force start application
        "tag": ""   # load from committed image with tag
    }

    response = app.start_app_by_id(app_id=APP_ID, **params)
    print(response)
    # OUTPUT
    # برنامه با شناسه 2688 و تعداد نسخه 1 به زودی اجرا خواهد شد!
